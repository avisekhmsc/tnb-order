<?php
	...
	if(!count($validation)):
		...
		if(!is_null($row)):
			...
			$sql = "UPDATE coupons SET status='0',full_name='".$request['full_name']."',phone_no='".$request['phone_no']."',whatsapp_no='".$request['whatsapp_no']."',email_address='".$request['email_address']."',dob='".$request['dob']."',anniversary='".$request['anniversary']."',franchise='".$request['franchise']."' WHERE id='".$row['id']."'";
